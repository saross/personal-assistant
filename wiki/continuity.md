...
- **Open.** Round 3c (`claude/audit-round3c`, running): the pre-existing
  ...
  (bake-off follow-ups, 45deb1f). Open with re-audits or fix rounds in
  flight: #124 (archive pipeline, second re-audit), #127 (hermeticity
  guards and the midnight flake, third re-audit), #128 (style-analyser
  scripts, round 4g-2), #129 (memory readers and anchors, round 4f-3),
  #132 (daily-sync follow-ups, re-audit); rounds 4d-3 and 4e-3 running.
  Main suite about 3,300. Two operational lessons recorded in the
