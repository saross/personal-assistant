...
- Held-over gates: two working-notes candidates surfaced at this handoff (throughput-extraction method; slots-close-vs-calendar-drift) — pending Shawn's verdict; re-surface at next /recap or /handoff. Prior pending user-obs batches (2026-06-20, 2026-06-21) still await verdicts.
